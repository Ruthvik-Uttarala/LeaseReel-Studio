...
export function Navigation() {
  ...
  return (
    <>
      ...
      <MagneticButton className="bottom-cta" href={pilotHref()}>
        Request a $149 pilot
      </MagneticButton>
    </>
  );
...
function pilotHref() {
  const params = new URLSearchParams({ subject: pilotIntent.subject, body: pilotIntent.body });
  return `mailto:${pilotIntent.to}?${params.toString()}`;
}
